/* FuelManagement__mapping.c */

#include "FuelManagement__type.h"
#include "FuelManagement__interface.h"
#include "FuelManagement__mapping.h"
...
const MappingEntry scope_9_entries[9] = {
    ...
    /* 3 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L4_SetTankFullVisible_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L7", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L7_SetTankFullVisible_1, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L8_SetTankFullVisible_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L9_SetTankFullVisible_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L10_SetTankFullVisible_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L11_SetTankFullVisible_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 8 }
};
...
const MappingEntry scope_8_entries[12] = {
    ...
    /* 5 */ { MAP_LOCAL, "_L4", NULL, sizeof(intMsg), (size_t)&outputs_ctx._L4_RepaintFuelLevel_1, &_Type_intMsg_Utils, NULL, NULL, &scope_3, 1, 5 },
    ...
    /* 8 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L7_RepaintFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L8_RepaintFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L9", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L9_RepaintFuelLevel_1, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 10 },
...
const MappingEntry scope_7_entries[23] = {
    ...
    /* 3 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L2_EnableWidgets_1, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L3_EnableWidgets_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L4_EnableWidgets_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 5 },
    ...
    /* 8 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L8_EnableWidgets_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L9_EnableWidgets_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L10_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L11_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L12_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L13_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L14", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L14_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L15", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L15_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L16", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L16_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L17", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L17_EnableWidgets_1, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L18", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L18_EnableWidgets_1, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L19", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L19_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L20_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L21", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L21_EnableWidgets_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 21 },
...
const MappingEntry scope_6_entries[28] = {
    ...
    /* 3 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L2_SetFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 3 },
    ...
    /* 6 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L5_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L6_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L8_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L10_SetFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L12_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L13_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L14", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L14_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L15", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L15_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L17", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L17_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L18", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L18_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L20_SetFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L21", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L21_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L22_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L23", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L23_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L24", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L24_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L25", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L25_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L27", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L27_SetFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L28", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L28_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L29", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L29_SetFuelLevel_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L30", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L30_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L31", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L31_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L32", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L32_SetFuelLevel_1, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 27 }
};
...
const MappingEntry scope_1_entries[32] = {
    ...
    /* 18 */ { MAP_LOCAL, "_L8", NULL, sizeof(intMsg), (size_t)&outputs_ctx._L8, &_Type_intMsg_Utils, NULL, NULL, &scope_3, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L7", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L7, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L9", NULL, sizeof(BoolMsg), (size_t)&outputs_ctx._L9, &_Type_BoolMsg_Utils, NULL, NULL, &scope_2, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L10", NULL, sizeof(intMsg2), (size_t)&outputs_ctx._L10, &_Type_intMsg2_Utils, NULL, NULL, &scope_4, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L11, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_uint32), (size_t)&outputs_ctx._L12, &_Type_kcg_uint32_Utils, NULL, NULL, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L13, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 24 },
