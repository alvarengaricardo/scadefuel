...
uaa_size a661_com_csp_widget_PushButton(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_VISIBLE__emit__, uaa_bool A661_VISIBLE_Visible_);
uaa_size a661_com_csp_widget_GpRectangle(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_COLOR_INDEX__emit__, kcg_uint8 A661_COLOR_INDEX_ColorIndex_, uaa_bool A661_FILL_INDEX__emit__, kcg_uint8 A661_FILL_INDEX_FillIndex_, uaa_bool A661_SIZE_Y__emit__, uaa_uint32 A661_SIZE_Y_SizeY_, uaa_bool A661_VISIBLE__emit__, uaa_bool A661_VISIBLE_Visible_);
uaa_size a661_com_csp_widget_ComboBox(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_VISIBLE__emit__, uaa_bool A661_VISIBLE_Visible_);
uaa_size a661_com_csp_widget_BlinkingContainer(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_VISIBLE__emit__, uaa_bool A661_VISIBLE_Visible_);
