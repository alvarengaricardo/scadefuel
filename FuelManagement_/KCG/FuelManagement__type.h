#ifndef FUELMANAGEMENT__TYPES_CONVERSION
#define FUELMANAGEMENT__TYPES_CONVERSION
 ...
 ** BoolMsg 
 ****************************************************************/
extern int BoolMsg_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_BoolMsg_string(const char *str, char **endptr);
extern int string_to_BoolMsg(const char *str, void *pValue, char **endptr);
extern int is_BoolMsg_double_conversion_allowed();
extern int BoolMsg_to_double(const void *pValue, double *nValue);
extern int is_BoolMsg_long_conversion_allowed();
extern int BoolMsg_to_long(const void *pValue, long *nValue);
extern void compare_BoolMsg(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_BoolMsg_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_BoolMsg(void *pValue);
extern int release_BoolMsg(void *pValue);
extern int copy_BoolMsg(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_BoolMsg_Utils;

/****************************************************************
 ** intMsg 
 ****************************************************************/
extern int intMsg_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_intMsg_string(const char *str, char **endptr);
extern int string_to_intMsg(const char *str, void *pValue, char **endptr);
extern int is_intMsg_double_conversion_allowed();
extern int intMsg_to_double(const void *pValue, double *nValue);
extern int is_intMsg_long_conversion_allowed();
extern int intMsg_to_long(const void *pValue, long *nValue);
extern void compare_intMsg(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_intMsg_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_intMsg(void *pValue);
extern int release_intMsg(void *pValue);
extern int copy_intMsg(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_intMsg_Utils;

/****************************************************************
 ** intMsg2 
 ****************************************************************/
extern int intMsg2_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_intMsg2_string(const char *str, char **endptr);
extern int string_to_intMsg2(const char *str, void *pValue, char **endptr);
extern int is_intMsg2_double_conversion_allowed();
extern int intMsg2_to_double(const void *pValue, double *nValue);
extern int is_intMsg2_long_conversion_allowed();
extern int intMsg2_to_long(const void *pValue, long *nValue);
extern void compare_intMsg2(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_intMsg2_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_intMsg2(void *pValue);
extern int release_intMsg2(void *pValue);
extern int copy_intMsg2(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_intMsg2_Utils;
...
#endif /*FUELMANAGEMENT__TYPES_CONVERSION */
